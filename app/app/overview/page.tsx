      ...
      <div className="space-y-6">
        ...
        <PageSection title="Quick actions" description="Use real workflow entry points to start or continue client work.">
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            ...
            <Link href={"/app/chasing" as any} className="block"><SectionCard className="p-4 transition hover:bg-white/[0.05]"><p className="text-sm font-semibold text-white">Open client chasing</p><p className="mt-2 text-sm text-slate-400">Preview and audit safe follow-up reminders.</p></SectionCard></Link>
